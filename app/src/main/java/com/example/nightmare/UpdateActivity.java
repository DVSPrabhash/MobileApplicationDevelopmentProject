...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_button.setOnClickListener(view -> {
            ...
            myDB.updateData(id, brand, model, condition, price, description);
    ...
    void getAndSetIntentData() {
        if(getIntent().hasExtra("id") && getIntent().hasExtra("brand") && getIntent().hasExtra("model") &&
                getIntent().hasExtra("condition") && getIntent().hasExtra("price") && getIntent().hasExtra("description")){
