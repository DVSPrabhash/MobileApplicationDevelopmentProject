...
public class MainHimashaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_himasha);

        recyclerView = findViewById(R.id.recyclerView);
        add_button = findViewById(R.id.add_button);
        empty_imageview = findViewById(R.id.empty_imageview);
        add_button.setOnClickListener(view -> {
            Intent intent = new Intent(MainHimashaActivity.this, AddActivity.class);
            startActivity(intent);
        });

        myDB = new MyDatabaseHelper(MainHimashaActivity.this);
        ...
        customAdapter = new CustomAdapter(MainHimashaActivity.this, MainHimashaActivity.this, mobile_id, mobile_brand, mobile_model,
                mobile_condition, mobile_price, mobile_description);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(MainHimashaActivity.this));
    }
    @Override
    ...
    void confirmDialog(){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                MyDatabaseHelper myDB = new MyDatabaseHelper(MainHimashaActivity.this);
                myDB.deleteAllData();
                //refresh
                Intent intent = new Intent(MainHimashaActivity.this, MainHimashaActivity.class);
                startActivity(intent);
                finish();
            }
        });
