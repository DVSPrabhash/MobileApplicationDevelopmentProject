...
public class iphonexActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneName.setText("Iphone x");
        imageView.setImageResource(R.drawable.apple10);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(iphonexActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    Toast.makeText(iphonexActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
                } else {
                    quantity--;
                    displayQuantity();
                    int mPrice = basePrice * quantity;
    ...
    private boolean SaveCart() {
        ...
        if (addtemperd.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_HASTEMPERD, "Black: YES");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_HASTEMPERD, "Black: NO");

        }

        if (adddbackcover.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_HASBACKCOVER, "Dark blue: YES");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_HASBACKCOVER, "Dark blue: NO");
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        String[] projection = {OrderContract.OrderEntry._ID,
                ...
                OrderContract.OrderEntry.COLUMN_HASTEMPERD,
                OrderContract.OrderEntry.COLUMN_HASBACKCOVER
        };
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int backcover = cursor.getColumnIndex(OrderContract.OrderEntry.COLUMN_HASTEMPERD);
            int temperd = cursor.getColumnIndex(OrderContract.OrderEntry.COLUMN_HASBACKCOVER);
