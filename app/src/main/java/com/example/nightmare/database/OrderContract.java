...
public class OrderContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.nightmare";
    ...
    public static abstract class OrderEntry implements BaseColumns{
        ...
        public static final String COLUMN_HASBACKCOVER = "hasbackcover";
        public static final String COLUMN_HASTEMPERD = "hastemperd";
    }
}
